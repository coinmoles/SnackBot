...
const addDefaultInfo = (embed: MessageEmbed): MessageEmbed => {
    return embed.setTitle("간식봇 세모의 도움말")
        ...
        .addFields([
            ...
            { name: "세모야 급식 <날짜>", value: "그 날짜의 급식 및 간식 정보를 보여드려요" },
            { name: "세모야 아침 <날짜>", value: "그 날짜의 아침 정보를 보여드려요" },
            { name: "세모야 점심 <날짜>", value: "그 날짜의 점심 정보를 보여드려요" },
            { name: "세모야 저녁 <날짜>", value: "그 날짜의 저녁 정보를 보여드려요" },
...
const addInfoWithDate = (command: string, description: string, embed: MessageEmbed): MessageEmbed => {
    return embed.setTitle(`세모야 ${command} <날짜>`)
